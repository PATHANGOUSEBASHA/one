...
<body>
	<h1 style="color: navyblue; font-size: 40px;" align="center">HEY WE DEPLOYED OUR APP USING JENKINS</h1>
	...
	<h1 style="color: skyblue; font-size: 40px;" align="center">we are done with ci/cd</h1>
	<h1 style="color: browm; font-size: 40px;" align="center">we integraded nexus also/cd</h1>
